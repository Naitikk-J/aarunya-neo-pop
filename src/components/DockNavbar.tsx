                ...
                <motion.div
                  ...
                  style={{
                    background: isHovered
                      ? `radial-gradient(circle at 30% 30%, hsl(${300 + index * 30} 100% 60%), hsl(${300 + index * 30} 100% 40%))`
                      : `radial-gradient(circle at 30% 30%, hsl(${300 + index * 30} 80% 45%), hsl(${300 + index * 30} 90% 25%))`,
                    boxShadow: isHovered
                      ? `0 0 20px hsl(${300 + index * 30} 100% 50%), inset -2px -2px 5px rgba(0,0,0,0.5), inset 2px 2px 5px rgba(255,255,255,0.2)`
